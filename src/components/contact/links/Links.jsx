        ...
        <div className="wrapper">
          <div className="social">
            ...
            <div className="social-links">
              ...
              <a href="https://www.youtube.com/c/rsk%20edits" target={'_blank'}><i className="fa fa-youtube" aria-hidden="true"></i></a>
              <a href="https://leetcode.com/sRenjithsamuel/" target={'_blank'}><i className="fa fa-code" aria-hidden="true"></i></a>
            </div>
          </div>
        </div>
      </div>
